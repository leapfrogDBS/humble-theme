...
<div id="<?php echo $unique_popup_id; ?>" class="page-popup modal fixed z-50 inset-0 overflow-auto bg-deep-blue bg-opacity-60 hidden">
  ...
  <div class="modal-wrapper h-full flex items-center justify-center">
        <!-- Modal content -->
        <div id="content-<?php echo $unique_popup_id; ?>" class="popup-content modal-content w-full sm:w-3/4 relative bg-white m-auto p-6 shadow-lg max-w-2xl bg-cover bg-no-repeat" style="<?php echo $bg_style; ?>">
